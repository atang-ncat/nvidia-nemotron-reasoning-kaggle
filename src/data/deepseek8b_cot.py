...
Usage:
  ...
  python src/data/deepseek8b_cot.py [--category algebra] [--limit 100]
"""
...
NVIDIA_MODEL = "deepseek-ai/deepseek-r1-distill-llama-8b"

DATA_DIR = "/scratch2/atang/competitions/nemotron-kaggle/data"
OUTPUT_DIR = "/scratch2/atang/competitions/nemotron-kaggle/data/deepseek8b_cot"
