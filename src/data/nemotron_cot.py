#!/usr/bin/env python3
"""
Generate Chain-of-Thought reasoning traces using NVIDIA NIM API (Nemotron-Super).

For each puzzle where our deterministic solver fails, we ask Nemotron-Super
to explain step-by-step how to arrive at the known answer. This gives us
high-quality reasoning traces for training.

Usage:
  export NVIDIA_API_KEY=nvapi-...
  python src/data/nemotron_cot.py [--category algebra] [--limit 100]
"""
...
OUTPUT_DIR = "/scratch2/atang/competitions/nemotron-kaggle/data/nemotron_cot"

# Rate limiting
MAX_RPM = 35  # slightly under 40 to be safe
SLEEP_BETWEEN_REQUESTS = 60.0 / MAX_RPM  # ~1.7 seconds
